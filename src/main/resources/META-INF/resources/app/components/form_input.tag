<form_input>
    <div class="form-check" if={ opts.type == 'check'}>
      <input class="form-check-input" type="checkbox" value="" id={ opts.id+'_input' } name={ opts.name+'_input' } checked={ opts.checked } required={ opts.required }>
    ...
    <input if={ opts.type == 'text' || opts.type == 'password' || opts.type == 'email'} 
        class="form-control" id={ opts.id+'_input' } name={ opts.name+'_input' } type={ opts.type } required={ opts.required }
    ...
    <textarea if={ opts.type == 'textarea'} 
        class="form-control" id={ opts.id+'_input' } name={ opts.name+'_input' } rows={ self.rows } required={ opts.required }
