// Get the list of built-in widget types
let getWidgetTypes = function () {
    return [
        'bar_chart',
        'button',
        'date',
...
// Get the list of locally defined widget types
let getLocalWidgetTypes = function () {
    return []
}
// Get the list of widgets types delivered by the community
let getCommunityWidgetTypes = function () {
    return []
}
let chartOptions={
    line:{
